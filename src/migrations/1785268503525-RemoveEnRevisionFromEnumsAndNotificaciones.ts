...
export class RemoveEnRevisionFromEnumsAndNotificaciones1785268503525 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TYPE "clasificacion_lote_enum" RENAME TO "clasificacion_lote_enum_old"`);
        await queryRunner.query(`CREATE TYPE "clasificacion_lote_enum" AS ENUM ('apto', 'no_apto')`);
        ...
        await queryRunner.query(`ALTER TYPE "notificaciones_tipo_enum" RENAME TO "notificaciones_tipo_enum_old"`);
        await queryRunner.query(`CREATE TYPE "notificaciones_tipo_enum" AS ENUM ('lote_no_apto')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TYPE "clasificacion_lote_enum" RENAME TO "clasificacion_lote_enum_new"`);
        await queryRunner.query(`CREATE TYPE "clasificacion_lote_enum" AS ENUM ('apto', 'no_apto', 'en_revision')`);
        await queryRunner.query(`
          ALTER TABLE "lotes"
          ALTER COLUMN "clasificacion" TYPE "clasificacion_lote_enum"
          USING clasificacion::text::"clasificacion_lote_enum"
        ...
        await queryRunner.query(`ALTER TYPE "notificaciones_tipo_enum" RENAME TO "notificaciones_tipo_enum_new"`);
        await queryRunner.query(`CREATE TYPE "notificaciones_tipo_enum" AS ENUM ('lote_no_apto', 'lote_en_revision')`);
        await queryRunner.query(`
          ALTER TABLE "notificaciones"
          ALTER COLUMN "tipo" TYPE "notificaciones_tipo_enum"
          USING tipo::text::"notificaciones_tipo_enum"
